...
<action id=""a5"" commandName=""Edit"" causesValidation=""true"" />
    ...
    public class ControllerConfigurationUtility
    {
        ...
        public static Stream GetResourceStream(params System.String[] resourceNames)
        {
            Assembly a = typeof(ControllerConfigurationUtility).Assembly;
            Stream res = null;
            foreach (string resource in resourceNames)
            {
                res = a.GetManifestResourceStream(resource);
                if (res != null)
                	break;
            }
            return res;
        ...
        public static string GetResourceText(params System.String[] resourceNames)
        {
        ...
        public static string GetFileText(params System.String[] paths)
        {
