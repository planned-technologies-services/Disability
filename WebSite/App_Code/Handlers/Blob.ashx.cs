...
namespace MyCompany.Handlers
{
	public partial class BlobFactory
    {
        ...
        static BlobFactory()
        {
            ...
            RegisterHandler("CategoriesPicture", "\"dbo\".\"Categories\"", "\"Picture\"", new string[] {
                        "\"CategoryID\""}, "Categories Picture", "Categories", "Picture");
                ...
                if (ApplicationServices.IsTouchClient)
                {
                    ...
                    if (settings != null)
                    {
                        if (settings["width"] != null)
                        	thumbWidth = Convert.ToInt32(((JValue)(settings["width"])).Value);
                        if (settings["height"] != null)
                        	thumbHeight = Convert.ToInt32(((JValue)(settings["height"])).Value);
                    }
...
function UploadSuccess(key, message) { 
    ...
    public class BlobAdapter
    {
        ...
        public static string ValidationKey
        {
            get
            {
                return "EF2F52DAA33F91E37AA242439D4864C637206801722464F58AF387331550B41D9DF9E892E0865ABCA" +
                    "B39F41FD4A794387176F8C2083673264A89583AE3518D7C";
            }
        }
